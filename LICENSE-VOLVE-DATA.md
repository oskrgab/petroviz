...
The data is processed and displayed through a client-side DuckDB-WASM database for interactive exploration and visualization.

## License

The original Volve dataset is released under the **Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License (CC BY-NC-SA 4.0)**.
...
When using this project, please provide appropriate credit to Equinor for the original dataset:
...
- The Volve dataset license (CC BY-NC-SA 4.0) applies to the **data files** used in this application
- The Volve Explorer **software code** is licensed separately under the Apache License 2.0 (see LICENSE file)
- **Non-Commercial Use**: The CC BY-NC-SA 4.0 license restricts the data to non-commercial purposes
- **Share-Alike**: Any adaptations or derivatives of the data must be shared under the same license
- Users may substitute their own datasets for commercial applications
- Please comply with the terms of the Volve dataset license when using the included production data
