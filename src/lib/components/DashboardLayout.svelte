...
<div class="dashboard" class:compact-mode={isCompactMode.current}>
      ...
      <div class="logo-section">
        ...
        <div class="logo-icon">
          <svg viewBox="0 0 24 24" fill="currentColor">
            <path
              d="M12 2C12 2 5 10 5 15C5 18.866 8.134 22 12 22C15.866 22 19 18.866 19 15C19 10 12 2 12 2ZM12 20C9.239 20 7 17.761 7 15C7 11.512 11 5.695 12 4.357C13 5.695 17 11.512 17 15C17 17.761 14.761 20 12 20Z"
            />
            <ellipse
              cx="12"
              cy="15"
  ...
  <div class="dashboard-content">
    ...
    <main class="main-content">
      {#if mainChart}
        <section
          class="chart-section main-chart"
          aria-label="Daily Production Chart"
        >
          {@render mainChart()}
        </section>
      {/if}
      ...
      {#if rangeSelector}
        <section
          class="chart-section range-selector"
      ...
      <div class="bottom-charts">
        {#if pieChart}
          <section
            class="chart-section pie-chart"
            aria-label="Cumulative Production Chart"
          >
            {@render pieChart()}
          </section>
        {/if}
  ...
  <footer class="dashboard-footer">
    ...
    <div class="footer-right">
      <span class="author-credit">
        Made with ❤️ by <a
          href="https://ocortez.com"
          target="_blank"
          rel="noopener">Oscar Cortez</a
        >
      </span>
    </div>
  </footer>
